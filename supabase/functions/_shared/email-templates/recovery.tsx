...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your ALC Shipper Portal password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We received a request to reset the password for your ALC Shipper Portal account. Click below to choose a new one.
        </Text>
