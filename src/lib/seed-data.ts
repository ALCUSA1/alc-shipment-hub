...
export async function autoSeedIfEmpty(userId: string) {
  ...
  const shipments = [
    { shipment_ref: "SEED-01", shipment_type: "export" as const, status: "pending_pricing", origin_port: "USLAX", destination_port: "CNSHA", mode: "ocean", carrier: "Maersk", incoterms: "FOB", vessel: "Maersk Sealand", voyage: "MA-2026-W12", etd: format(addDays(now, 5), "yyyy-MM-dd"), eta: format(addDays(now, 30), "yyyy-MM-dd"), company_id: companyMap["Pacific Trade Corp"] },
    { shipment_ref: "SEED-02", shipment_type: "import" as const, status: "pending_pricing", origin_port: "DEHAM", destination_port: "USNYC", mode: "ocean", carrier: "Hapag-Lloyd", incoterms: "CIF", vessel: "Hamburg Express", voyage: "HL-2026-E08", etd: format(addDays(now, 3), "yyyy-MM-dd"), eta: format(addDays(now, 22), "yyyy-MM-dd"), company_id: companyMap["Hamburg Logistics GmbH"] },
    ...
    { shipment_ref: "SEED-08", shipment_type: "export" as const, status: "pending_pricing", origin_port: "USLAX", destination_port: "SGSIN", mode: "air", carrier: "Singapore Airlines Cargo", incoterms: "FCA", airline: "Singapore Airlines Cargo", flight_number: "SQ-7952", airport_of_departure: "LAX", airport_of_destination: "SIN", etd: format(addDays(now, 7), "yyyy-MM-dd"), eta: format(addDays(now, 9), "yyyy-MM-dd"), company_id: companyMap["Pacific Trade Corp"] },
    { shipment_ref: "SEED-09", shipment_type: "export" as const, status: "draft", origin_port: "USCHI", destination_port: "MXZLO", mode: "ocean", carrier: "ZIM", incoterms: "FOB", company_id: companyMap["Pacific Trade Corp"] },
