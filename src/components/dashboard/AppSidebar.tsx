import { LayoutDashboard, Package, DollarSign, FileText, Users, Settings, LogOut, Truck, Warehouse, Radio } from "lucide-react";
...
const items = [
  ...
  { title: "EDI", url: "/dashboard/edi", icon: Radio },
