    ...
    <AdminLayout>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-6">
        ...
        <div className="rounded-xl border border-[hsl(220,15%,13%)] bg-[hsl(220,18%,10%)] p-5">
          ...
          <p className="text-2xl font-bold text-amber-400 mt-1">{notifications?.filter(n => !n.is_read).length || 0}</p>
        </div>
        <div className="rounded-xl border border-[hsl(220,15%,13%)] bg-[hsl(220,18%,10%)] p-5">
        ...
        <div className="rounded-xl border border-[hsl(220,15%,13%)] bg-[hsl(220,18%,10%)] overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {notifications?.length === 0 && <tr><td colSpan={4} className="px-4 py-8 text-center text-xs text-[hsl(220,10%,40%)]">No notifications</td></tr>}
            </tbody>
          </table>
        </div>
      )}
