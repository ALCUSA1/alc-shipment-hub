...
const ROLE_OPTIONS = [
  {
    ...
    companyType: "shipper",
    icon: Package,
    description: "I import, export or move goods and need a freight agent to handle my shipments, documentation and customs clearance.",
    responsibilities: [
      "Find and book trusted freight agents",
      "Real-time shipment tracking",
      "Competitive rates across all major shipping lines",
    ],
  },
  {
    value: "forwarder",
    ...
    icon: Ship,
    description: "I manage freight on behalf of shippers and want to earn commissions on every shipment I process through ALC.",
    responsibilities: [
      "Join free — no monthly commitment",
      "Access all major shipping lines",
      "ALC handles customs, documentation and tracking",
    ],
  },
  {
    value: "trucker",
